...
<div id="setting" style="height:350px;margin:10px 0 0 80px;padding:100px">
<form id="J_Form" name="form" action="DiaryServlet?action=playSetting" class="form-horizontal" method="post">
 <div class="control-group">
        <label class="control-label">播放：</label>
        <div class="controls">
          <select class="input-normal" id="auto" name="auto"> 
                <option value="1">自动播放</option>
                <option value="0">不自动播放</option>
              </select>
        </div>
        <button type="button" class="button button-primary offset1" style="height:20px;" onClick="$('#J_Form').submit()">保存</button>
      </div>
